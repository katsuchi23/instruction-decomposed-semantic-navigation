...
class Nav2OccupancyGridRelay(Node):
    """
    Subscribes to /local_costmap/costmap (nav_msgs/OccupancyGrid) and serves latest grid via ZMQ REP.
    ...
    def __init__(self):
        super().__init__("nav2_costmap_grid_relay")

        # Parameters
        self.declare_parameter("grid_topic", "/local_costmap/costmap")
        self.declare_parameter("zmq_port", 5564)
